...
const AboutUsCardComponent: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full gap-6 md:gap-10">
      {/* Heading */}
      <div className="md:w-[35vw] w-full flex items-center justify-center md:justify-start">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl  leading-tight text-center md:text-left">
          <span      style={{ fontFamily: "InstrumentSerif" }}  className="text-5xl md:text-6xl lg:text-7xl font-medium ">S</span>
          CSC of pharmacy{" "}
      ...
      <div className="md:w-3/5 w-full flex flex-col md:flex-row gap-6">
        {/* Left Card */}
        <div className="flex-1 bg-gray-100 rounded-4xl p-6 sm:p-8 md:p-10 flex flex-col justify-between min-h-[250px] md:min-h-[350px]">
        ...
        <div className="flex-1 flex flex-col gap-4">
          {/* Right Card */}
          <div className="bg-gray-100 rounded-4xl p-6 sm:p-8 md:p-10 flex flex-col justify-between min-h-[200px] md:min-h-[280px]">
            <h2 className="text-2xl md:text-3xl lg:text-4xl border-b-4 border-white text-[#CA8A04] pb-2">
              {rightCard.title}
            </h2>
            <div>
          ...
          {/* Navigation Buttons */}
          <div className="flex justify-start gap-4 mt-2 ml-3">
            <button
              type="button"
              onClick={handlePrev}
              className="bg-white rounded-2xl px-4 py-4 border-[0.1px] border-[#0D2048] hover:bg-[#F3F4F6] transition duration-300 cursor-pointer"
            >
              <FaChevronLeft size={15} className="text-[#0D2048]" />
            </button>
            <button
              type="button"
              onClick={handleNext}
              className="bg-[#0D2048] rounded-2xl px-4 py-4  transition duration-300 cursor-pointer"
            >
